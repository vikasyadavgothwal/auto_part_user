    ...
    <Card className="rounded-sm border-border bg-brand-panel">
      <CardContent className="space-y-6 p-6">
        ...
        <label className="flex cursor-pointer items-center justify-between gap-4 rounded-sm border-2 border-dashed border-border bg-brand-surface p-4 hover:border-primary">
          <span><span className="flex items-center gap-2 font-medium text-foreground"><Upload className="h-5 w-5" />Import CSV or Excel</span><span className="mt-1 block text-sm text-brand-muted">Columns: VIN No, Quantity, Target Price, Part Number, Part Name. Maximum file size: 5 MB.</span></span>
